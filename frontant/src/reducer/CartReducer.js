  ...
  if (action.type === "Add_TO_CART") {
    ...
    if (existingProduct) {
      ...
      cartProduct = {
        ...
        amount,
        colorImage: color.map((i) => i.image),
        colorTextName: color.map((i) => i.color_type),
      };
